$(document).ready(function () {
    ...
    async function loadCategoryItems(categoryId, categoryName) {
        ...
        try {
            const [lostItems, foundItems] = await Promise.all([
                loadItemsByCategory(`backend/rest/lost-items/category/${categoryId}`, 'Lost', categoryName),
                loadItemsByCategory(`backend/rest/found-items/category/${categoryId}`, 'Found', categoryName)
            ]);
    ...
    loadCategoryItems(categoryMap['Electronics'], 'Electronics');
});
